...
namespace Estructura_8
{
    class Origen
    {
        ...
        public static Origen Crear()
        {
            Origen origen = new Origen();

            origen.pais = asignar_pais();
            origen.localidad = asignar("localidad");
            origen.calle = asignar("calle");
            origen.numero_calle = asignar_numérico("número de calle");
            origen.numero_piso = asignar_numérico("número de piso");
